export const Teammates = () => {
    ...
    <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
      <div class="mx-auto max-w-screen-sm text-center mb-8 lg:mb-16 animate-fade-in-up">
        ...
        <div class="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700 animate-fade-in-left">
          ...
          <a href="#">
            ...
            <div class="p-5">
              ...
              <span class="text-gray-500 dark:text-gray-400">Junior Back-end Developer</span>
              <p class="mt-3 mb-4 font-light text-gray-500 dark:text-gray-400">
